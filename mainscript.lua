...
local MacLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Duc3435G/banamap/refs/heads/main/main.lua"))()
...
gameSection:Toggle({
    ...
    Callback = function(val)
        ...
        if val then
            queue_on_teleport([[
                repeat task.wait() until game:IsLoaded()
                loadstring(game:HttpGet('https://raw.githubusercontent.com/Duc3435G/banamap/refs/heads/main/mainscript.lua'))()
            ]])
        end
    end
})
